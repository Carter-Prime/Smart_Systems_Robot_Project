...
{                                                                                           //  It then moves onto waiting for the user button to be pressed which will then call function to move to the starting line and printing out "ready"
    ...
    while(counter < 2){                                                                                                                         //  the stop criteria is all sensors reading black twice.
        reflectance_read(&ref);
        if(ref.r1 < 17000 && ref.l1 < 17000 && onTrack){
        ...
        if(ref.r1 > 22000 && ref.r2 > 22000 && ref.r3 > 22000 && ref.l1 > 20000 && ref.l2 > 20000 && ref.l3 > 20000 && isblack == 0){
            counter++;
            isblack = 1;
            if(counter < 2)
                while(ref.r3 + ref.r2 + ref.r1 + ref.l1 + ref.l2 + ref.l3 > 110000){
                    reflectance_read(&ref);
                    motor_forward(250,0);
                }
        }
